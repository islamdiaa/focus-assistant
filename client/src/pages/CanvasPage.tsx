  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="glass-subtle border-b px-4 py-3 flex items-center justify-center gap-3">
        <button
          onClick={goBack}
          className="p-1.5 rounded-lg hover:bg-black/5 dark:hover:bg-[oklch(0.20_0.015_155)] transition-colors active:scale-[0.97] transform-gpu"
        ...
        <button
          ...
          disabled={isToday}
          className={cn(
            "p-1.5 rounded-lg transition-colors active:scale-[0.97] transform-gpu",
            isToday
        ...
        {!isToday && (
          <button
            onClick={goToday}
            className="ml-1 px-2.5 py-1 text-xs font-medium rounded-md bg-warm-sage/10 text-warm-sage hover:bg-warm-sage/20 transition-colors active:scale-[0.97] transform-gpu"
          >
            Today
          </button>
        )}
