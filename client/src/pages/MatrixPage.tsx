      ...
      <div className="flex items-center gap-1.5">
        ...
        {PRIORITY_OPTIONS.map(opt => (
          <button
            ...
            className={`text-[10px] px-2 py-1 rounded-md border font-medium transition-all active:scale-[0.97] transform-gpu
    ...
    return (
      ...
      >
        ...
        <button
          ...
          title="Edit task"
          className="p-2 rounded text-muted-foreground/40 hover:text-warm-blue hover:bg-warm-blue-light/50 transition-colors active:scale-[0.97] transform-gpu opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 hover-action"
        >
  ...
  return (
    <div className="p-4 lg:p-8">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        {!showPanel && (
          <button
            ...
            className="shrink-0 glass rounded-xl px-2 py-4 lg:flex items-center text-muted-foreground hover:text-foreground transition-colors active:scale-[0.97] transform-gpu hidden"
          >
      ...
      {!showPanel && (
        <button
          onClick={() => setShowPanel(true)}
          className="mt-4 w-full glass rounded-xl px-4 py-3 flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground transition-colors active:scale-[0.97] transform-gpu text-sm"
        >
