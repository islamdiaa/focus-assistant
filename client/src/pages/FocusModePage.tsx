                    ...
                    {activeTasks.length === 0 ? (
                      ...
                      activeTasks.map(t => (
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 hover:bg-warm-sand/30 transition-colors active:scale-[0.97] transform-gpu border-b border-border/30 last:border-0"
                        >
