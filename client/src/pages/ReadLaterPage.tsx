    ...
    <div className="p-4 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <button
          ...
          className={`rounded-xl p-3 text-center border transition-all active:scale-[0.97] transform-gpu ${filterStatus === "unread" ? "border-warm-terracotta/40 bg-warm-terracotta/10" : "border-white/15 dark:border-white/10 glass hover:bg-warm-terracotta/5"}`}
        >
        ...
        <button
          ...
          className={`rounded-xl p-3 text-center border transition-all active:scale-[0.97] transform-gpu ${filterStatus === "reading" ? "border-warm-blue/40 bg-warm-blue/10" : "border-white/15 dark:border-white/10 glass hover:bg-warm-blue/5"}`}
        >
        ...
        <button
          ...
          className={`rounded-xl p-3 text-center border transition-all active:scale-[0.97] transform-gpu ${filterStatus === "read" ? "border-warm-sage/40 bg-warm-sage/10" : "border-white/15 dark:border-white/10 glass hover:bg-warm-sage/5"}`}
        >
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {allTags.map(tag => (
              <button
                ...
                className={`text-xs px-2.5 py-1 rounded-full border transition-all active:scale-[0.97] transform-gpu ${
                  filterTag === tag
                  ...
                  <div className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <button
                        ...
                        className={`shrink-0 mt-0.5 w-8 h-8 rounded-lg flex items-center justify-center transition-all active:scale-[0.97] transform-gpu ${cfg.bg} hover:opacity-80`}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button
                            ...
                            className="shrink-0 p-1 rounded-md text-muted-foreground hover:text-foreground hover:bg-warm-sand/50 transition-colors active:scale-[0.97] transform-gpu"
                          >
                            {isExpanded ? (
                              ...
                              {item.tags.map(tag => (
                                ...
                                >
                                  ...
                                  <button
                                    ...
                                    className="p-1 rounded hover:text-red-500 transition-colors active:scale-[0.97] transform-gpu"
                                  >
                                    <X className="w-3.5 h-3.5" />
                                  </button>
                                </span>
  ...
  if (!open) {
    return (
      <button
        ...
        className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-warm-lavender px-2 py-1 rounded-full border border-dashed border-border hover:border-warm-lavender/40 transition-colors active:scale-[0.97] transform-gpu"
      >
  ...
  return (
    <div className="inline-flex items-center gap-1">
      ...
      <button
        ...
        className="p-1.5 rounded text-warm-lavender hover:text-warm-lavender/80 hover:bg-warm-lavender/10 transition-colors active:scale-[0.97] transform-gpu"
      >
        <Check className="w-4 h-4" />
      </button>
      <button
        onClick={() => setOpen(false)}
        className="p-1.5 rounded text-muted-foreground hover:text-foreground hover:bg-warm-sand/50 transition-colors active:scale-[0.97] transform-gpu"
      >
        <X className="w-4 h-4" />
      </button>
    </div>
