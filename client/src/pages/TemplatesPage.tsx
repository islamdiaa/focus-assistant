      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Save and reuse task sets for recurring workflows
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            onClick={createFromCurrentTasks}
            variant="outline"
          ...
          >
            ...
            <span className="hidden sm:inline">From Tasks</span>
          </Button>
                ...
                <div>
                  ...
                  <div className="space-y-1.5 mb-3">
                    {tasks.map((t, i) => (
                      ...
                      >
                        <span
                          className={`text-xs px-1.5 py-0.5 rounded ${PRIORITY_COLORS[t.priority]}`}
                        >
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyDown={e =>
                        e.key === "Enter" &&
                        (e.preventDefault(), addTaskToTemplate())
                      }
      ...
      {templates.length === 0 ? (
        <div className="bg-card rounded-2xl border border-border p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Create a template to save a reusable set of tasks.
          </p>
        </div>
      ) : (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex gap-1.5">
                    <Button
                      ...
                      size="sm"
                      className="bg-warm-sage hover:bg-warm-sage/90 text-white gap-1.5 text-xs"
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      variant="ghost"
                      className="text-muted-foreground hover:text-warm-terracotta"
                    >
                    ...
                    >
                      {tmpl.tasks.map((t, i) => (
                        ...
                        >
                          ...
                          {t.subtasks && t.subtasks.length > 0 && (
                            <span className="text-[10px] text-muted-foreground bg-warm-sand/30 px-1.5 py-0.5 rounded">
