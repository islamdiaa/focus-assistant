...
│   │       ├── DailyPlannerPage.tsx # Today view: full task/reminder actions, Actioned Today, no monitoring
...
| -------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Task           | id, title, priority, status, dueDate, category, energy, quadrant, recurrence, subtasks, pinnedToday, statusChangedAt | Status: `active`/`done`/`monitored`. `statusChangedAt` tracks when status last changed (ISO string). Supports daily/weekly/monthly/quarterly/weekdays recurrence. Monitored = waiting on external action. |
